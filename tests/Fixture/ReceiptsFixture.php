...
class ReceiptsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'bank_cash_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'bank_cash_id' => 1,
            'created_by' => 1,
            'created_on' => '2017-04-11',
            'payment_mode' => 'Lorem ipsum dolor sit amet',
            'company_id' => 1,
            'transaction_date' => '2017-04-11',
            'edited_by' => 1,
            'edited_on' => '2017-04-11',
