...
class DebitNotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'customer_suppiler_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'voucher_no' => 'Lorem ip',
            'created_on' => '2017-05-23',
            'transaction_date' => '2017-05-23',
            'customer_suppiler_id' => 1,
            'company_id' => 1,
            'created_by' => 1,
            'edited_by' => 1,
            'edited_on' => '2017-05-23',
