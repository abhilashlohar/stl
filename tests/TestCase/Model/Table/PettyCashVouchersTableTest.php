...
use App\Model\Table\PettyCashVouchersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PettyCashVouchersTable Test Case
 */
class PettyCashVouchersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PettyCashVouchersTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PettyCashVouchers') ? [] : ['className' => 'App\Model\Table\PettyCashVouchersTable'];
        $this->PettyCashVouchers = TableRegistry::get('PettyCashVouchers', $config);
    }
