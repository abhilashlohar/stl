...
use App\Model\Table\InventoryTransferVouchersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\InventoryTransferVouchersTable Test Case
 */
class InventoryTransferVouchersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\InventoryTransferVouchersTable
     */
    public $InventoryTransferVouchers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('InventoryTransferVouchers') ? [] : ['className' => 'App\Model\Table\InventoryTransferVouchersTable'];
        $this->InventoryTransferVouchers = TableRegistry::get('InventoryTransferVouchers', $config);
    }
    ...
    {
        unset($this->InventoryTransferVouchers);
