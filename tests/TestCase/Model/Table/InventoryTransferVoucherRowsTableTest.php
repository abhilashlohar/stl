...
use App\Model\Table\InventoryTransferVoucherRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\InventoryTransferVoucherRowsTable Test Case
 */
class InventoryTransferVoucherRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\InventoryTransferVoucherRowsTable
     */
    public $InventoryTransferVoucherRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('InventoryTransferVoucherRows') ? [] : ['className' => 'App\Model\Table\InventoryTransferVoucherRowsTable'];
        $this->InventoryTransferVoucherRows = TableRegistry::get('InventoryTransferVoucherRows', $config);
    }
    ...
    {
        unset($this->InventoryTransferVoucherRows);
