...
use App\Model\Table\HotelExpensesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\HotelExpensesTable Test Case
 */
class HotelExpensesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\HotelExpensesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('HotelExpenses') ? [] : ['className' => 'App\Model\Table\HotelExpensesTable'];
        $this->HotelExpenses = TableRegistry::get('HotelExpenses', $config);
    }
