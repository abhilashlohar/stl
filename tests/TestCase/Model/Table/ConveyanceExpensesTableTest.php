...
use App\Model\Table\ConveyanceExpensesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ConveyanceExpensesTable Test Case
 */
class ConveyanceExpensesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ConveyanceExpensesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ConveyanceExpenses') ? [] : ['className' => 'App\Model\Table\ConveyanceExpensesTable'];
        $this->ConveyanceExpenses = TableRegistry::get('ConveyanceExpenses', $config);
    }
