...
use App\Model\Table\FinancialMonthsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\FinancialMonthsTable Test Case
 */
class FinancialMonthsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\FinancialMonthsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('FinancialMonths') ? [] : ['className' => 'App\Model\Table\FinancialMonthsTable'];
        $this->FinancialMonths = TableRegistry::get('FinancialMonths', $config);
    }
