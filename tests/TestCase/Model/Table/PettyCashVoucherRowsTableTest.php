...
use App\Model\Table\PettyCashVoucherRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PettyCashVoucherRowsTable Test Case
 */
class PettyCashVoucherRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PettyCashVoucherRowsTable
     */
    public $PettyCashVoucherRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PettyCashVoucherRows') ? [] : ['className' => 'App\Model\Table\PettyCashVoucherRowsTable'];
        $this->PettyCashVoucherRows = TableRegistry::get('PettyCashVoucherRows', $config);
    }
    ...
    {
        unset($this->PettyCashVoucherRows);
