...
use App\Model\Table\ApproveLeavesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ApproveLeavesTable Test Case
 */
class ApproveLeavesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ApproveLeavesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ApproveLeaves') ? [] : ['className' => 'App\Model\Table\ApproveLeavesTable'];
        $this->ApproveLeaves = TableRegistry::get('ApproveLeaves', $config);
    }
