...
use App\Model\Table\RequestTravellingsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequestTravellingsTable Test Case
 */
class RequestTravellingsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequestTravellingsTable
     */
    public $RequestTravellings;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequestTravellings') ? [] : ['className' => 'App\Model\Table\RequestTravellingsTable'];
        $this->RequestTravellings = TableRegistry::get('RequestTravellings', $config);
    }
