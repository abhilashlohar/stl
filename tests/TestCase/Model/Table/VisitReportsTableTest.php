...
use App\Model\Table\VisitReportsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitReportsTable Test Case
 */
class VisitReportsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitReportsTable
     */
    public $VisitReports;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitReports') ? [] : ['className' => 'App\Model\Table\VisitReportsTable'];
        $this->VisitReports = TableRegistry::get('VisitReports', $config);
    }
